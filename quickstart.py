...
if useGUI == False :
    ...
    username = 'individualidp@gmail.com' # LinkedIn Username
    password = 'Did@mi84' # LinkedIn Password
    language = 'en' # LinkedIn default language (en, es, pt)
    position = 'Cloud Engineer' # Job position
    location = 'San Diego' # location where to apply (e.g. Barcelona)
    resumeloctn = 'C:\resume'  # Directory path where your document is
