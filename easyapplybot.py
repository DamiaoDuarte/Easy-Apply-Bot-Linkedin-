        ...
        try:
            ...
            while not submit_button:
                if language == "en":
                    ...
                    submit_button = self.wait.until(
                        EC.element_to_be_clickable((By.CSS_SELECTOR, "button[aria-label='Enviar solicitud']")))
...
if __name__ == '__main__':
    ...
    if useGUI == True:
        ...
        # get user info info
        individualidp@gmail.com = app.frames["StartPage"].username
        Did@mi84 = app.frames["StartPage"].password
        en = app.frames["PageOne"].language
        Sweden = app.frames["PageTwo"].position
